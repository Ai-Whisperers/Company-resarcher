...
class QueryRankingResult:
    ...
    def get_queries_above_threshold(self, threshold: float = 0.5) -> List[str]:
        ...
        return [
            q.query for q in self.ranked_queries
...
[
    ...
    def _needs_language_variants(self) -> bool:
        ...
        spanish_countries = {
            "Paraguay", "Argentina", "Chile", "Colombia", "Mexico",
    ...
    def _parse_ranked_queries(
                ...
                for item in data:
                    ...
                    if query and query not in seen_queries:
                        ...
                        ranked.append(RankedQuery(
                            query=query,
                            effectiveness_score=min(1.0, max(0.0,
                                float(item.get("effectiveness_score", 0.5)))),
        ...
        # Fallback
        return [
            RankedQuery(query=q, effectiveness_score=0.5, category="unknown", language="en")
            for q in original_queries
        ]
