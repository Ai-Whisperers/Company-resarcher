...
from ..domain.domain_filter import get_domain_filter

# Type checking imports to avoid circular dependencies
if TYPE_CHECKING:
    from ...services.data import PersistentSourceRegistry
...
def create_incremental_filter(
    ...
    """
    from ...services.data import get_source_registry
    from ...services.research import get_data_analyzer
