...
# Optional dependencies for hybrid retrieval
try:
    import numpy as np
...
class HybridRetriever:
    ...
    def __init__(
        ...
        if not HAS_HYBRID_DEPS:
            logger.warning(
                "HybridRetriever dependencies not installed. "
                "Install with: pip install sentence-transformers rank-bm25 numpy"
            )
            return
