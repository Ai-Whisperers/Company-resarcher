...
- Poor quality (0.0-0.2): Wrong company, outdated, or unreliable"""
        ...
        try:
            ...
            return QualityScore(
                ...
                assessment_confidence=min(
                    1.0, max(0.0, float(data.get("assessment_confidence", 0.5)))
                ),
            )
    ...
    def get_section_best_sources(
        ...
        section_weights = {
            ...
            "strategic_context": lambda s: s.has_executive_info * 0.2
            + s.has_recent_news * 0.2,
        }
