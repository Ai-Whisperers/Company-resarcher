...
from src.core.logging import setup_logger, get_request_id
...
class SecurityMiddleware(BaseHTTPMiddleware):
    ...
    SECURITY_HEADERS = {
        ...
        # CSP - restrict resource loading to same origin, allow inline styles for UI frameworks
    ...
    async def _validate_request_body(
        ...
        try:
            ...
            # Fail-closed: block request if validation fails unexpectedly
            # This prevents attackers from bypassing security by causing parser errors
            return ValidationResult(
                is_safe=False,
                threat_level=ThreatLevel.HIGH,
                reason=f"Security validation error: {type(e).__name__}",
                matched_patterns=[],
