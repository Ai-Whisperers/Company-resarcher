...
# Source filtering (FIX-002, FIX-003, FIX-005)
from .source_filter import (
    ComprehensiveSourceFilter as LegacySourceFilter,
    FilterResult as LegacyFilterResult,
    FilteredSource as LegacyFilteredSource,
    FilterReason as LegacyFilterReason,
    create_source_filter,
    quick_filter_failed_sources,
)

# Comprehensive source filter v2.0 (#1-50 improvements)
from .comprehensive_filter import (
