...
**Description:** Datasets analysis engine, ingests Excel, Parquet, CSV and/or JSON and automatically extracts schemas, perform mapping and heuristics+levenshtein+regex parsing
**URL:** https://github.com/Ai-Whisperers/analysis-engine
**Visibility:** PRIVATE
