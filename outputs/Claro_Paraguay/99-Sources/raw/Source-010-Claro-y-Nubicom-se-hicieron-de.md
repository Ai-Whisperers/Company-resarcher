# Source-010: Claro y Nubicom se hicieron de espectro 5G en Paraguay y se prevé que el lanzamiento de servicios sea en marzo de 2026 – TeleSemana.com

## Metadata

| Field | Value |
|-------|-------|
| **URL** | https://www.telesemana.com/blog/2025/08/26/claro-y-nubicom-se-hicieron-de-espectro-5g-en-paraguay-y-se-preve-que-el-lanzamiento-de-servicios-sea-en-marzo-de-2026/ |
| **Type** | Social |
...
| Field | Value |
|-------|-------|
| **Sections Used** | creative_inspiration, investment_analysis, strategic_context |
...
¿Subasta sin neutralidad tecnológica?
El resultado del proceso resultó tal y como se lo preveía: el operador argentino y la filial local de América Móvil eran las únicas interesadas en acceder al
recurso espectral, luego que Tigo y Personal confirmaran su desinterés.
...
En el marco de ese mismo lineamiento, hace un trimestre
, el país presentó su Estrategia Nacional de Ciberseguridad para crear un “ecosistema digital seguro, sostenible y resiliente”.
Algo similar
a lo que ocurrió en Costa Rica con el Re
glamento Sobre Medidas de Ciberseguridad Aplicables a los Servicios de Telecomunicaciones Basados en la Tecnología de Quinta Generación Móvil (5G) y Superiores” aunque, con medidas judiciales de por medio, la
subasta se concretó sin dejar actores interesados afuera.
Etiquetas:
3.5 GHz
,
5G
...
Por
Noelia Tellez Tejada
Noelia Tellez Tejada se desempeña como Editora Adjunta en TeleSemana.com. Periodista y analista, acredita más de 20 años de labor ininterrumpida en medios gráficos, digitales y radiales. Está especializada en tecnología, negocios y telecomunicaciones. Su correo es noelia.tellez@telesemana.com
...
|--------|------------|
| **Reliability** | Medium |
| **Content Length** | 3667 characters |
